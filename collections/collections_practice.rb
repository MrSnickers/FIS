...
#6. create a new array in the following order
  ...
  # ["blake", "scott", "ashley"]
  collection_array_new = []
  collection_array_new[0] = collection_array[0]
  collection_array_new[1] = collection_array[2]
  collection_array_new[2] = collection_array[1]
...
outcome = {:blake => "winner", :ashley => "loser", :caroline => "loser", :carlos => "winner"}
winners = []
outcome.each do |competitor, win|
  winners << competitor if win == "winner"
end
